...
@section('title', 'Representativ Management' . ' | ' . 'Representativ Create')
...
@section('content')
{{ Form::open(['route' => 'admin.auth.representativ.store', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post']) }}
        ...
        <div class="row">
            <div class="col-sm-5">
                <h4 class="card-title mb-0">
                    ...
                    <small class="text-muted">Create Sales Team</small>
                </h4>
            </div>
            <div class="col-sm-5">
            </diV>
        ...
        <div class="row mt-4 mb-4">
            <div class="col">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        {{ Form::text('routes', null, ['class' => 'form-control', 'placeholder' => trans('Current Routes')]) }}
                    </div>
                    <!--col-->
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        {{ Form::textarea('comments', null, ['class' => 'form-control', 'placeholder' => trans('Comments')]) }}
                    </div>
                <!--col-->
                 </div>
            </div>
